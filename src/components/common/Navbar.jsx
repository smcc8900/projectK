...
export const Navbar = () => {
  const { currentUser, signOut, isAdmin, organization, hasFeature } = useAuth();
  ...
  const displayName = organization?.orgName || 'Payroll System';
  ...
  const navigationLinks = allLinks.filter(link => !link.feature || hasFeature(link.feature));
        ...
        <div className="flex justify-between items-center h-14">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <button
              ...
              className="hidden lg:flex items-center space-x-2 px-3 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors"
              title="Sign Out"
            >
              <LogOut className="w-4 h-4" />
              <span>Sign Out</span>
